...
public class ContactbaseTestContainer extends TestContainer {

    public ContactbaseTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/contactbase/app.properties",
    ...
    public static class Common extends ContactbaseTestContainer {

        public static final ContactbaseTestContainer.Common INSTANCE = new ContactbaseTestContainer.Common();
